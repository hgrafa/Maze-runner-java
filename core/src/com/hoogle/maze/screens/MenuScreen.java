...
public class MenuScreen implements Screen {
    ...
    public MenuScreen(MazeRunnerGame game) {
        ...
        table.add(new Label("Welcome to the Maze Game!", game.getSkin(), "title")).padBottom(80).row();

        // Create and add a button to go to the game screen
        //TextButton goToGameButton = new TextButton("Go To Game", game.getSkin());
        TextButton exitGameButton = new TextButton("Exit Game", game.getSkin());                // create new exitGameButton
        TextButton chooseLevelButton = new TextButton("Choose Level", game.getSkin());


        table.add(exitGameButton).width(300).row();                                                   // set position of exitGameButton and add it to the table
        //table.add(goToGameButton).width(300).row();
        table.add(chooseLevelButton).width(300).row();
