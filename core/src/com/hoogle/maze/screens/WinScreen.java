...
public class WinScreen implements Screen {
    ...
    public WinScreen(MazeRunnerGame game) {
        ...
        TextButton returnToMainMenuButton = new TextButton("Return To The Main Menu", game.getSkin()); // create new textbutton

        table.add(returnToMainMenuButton).width(600).row();                                                // add Textbutton the the row
